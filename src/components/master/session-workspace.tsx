    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.3fr_.7fr]">
        ...
        <div className="space-y-4">
          ...
          <Card className="tadeon-master-session-roster tadeon-surface rounded-2xl p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <Button
                size="sm"
                variant="ghost"
                onClick={onOpenCharacterOverview}
              >
                Comparar
              ...
              <div className="mt-4 space-y-2">
                {sheets.map((sheet) => (
                  <button
                    type="button"
                    key={sheet.id}
                    className="tadeon-master-session-character tadeon-interactive-card w-full rounded-xl border border-border/60 p-3 text-left"
                    onClick={() => onOpenSheet(sheet.id)}
                    aria-label={`Abrir ficha de ${sheet.name}`}
                  >
                    <div className="flex items-center justify-between gap-2">
                      <p className="tadeon-interactive-card__title truncate text-sm font-medium">
                        {sheet.name}
                      </p>
