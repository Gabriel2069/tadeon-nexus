        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-3xl text-xs leading-5 text-muted-foreground md:text-sm">Abra cada área em um viewport real, troque de formato e rode a inspeção de encaixe.</p>
            </div>
          </div>
