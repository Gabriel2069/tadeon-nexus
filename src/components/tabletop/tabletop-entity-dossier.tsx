        ...
        <div className="tadeon-entity-dossier__layout">
          ...
          <section className="tadeon-entity-dossier__content">
            ...
            {sheetSummary && (
              <div className="tadeon-entity-dossier__sheet">
                <div className="tadeon-entity-dossier__resources">
                  {Object.entries(sheetSummary.resources).map(
                    ([key, value]) => (
            ...
            {(visualConditions.length > 0 ||
              sheetSummary?.activeConditions.length) && (
              <div className="tadeon-entity-dossier__conditions">
                {[
                  ...new Set([
                    ...visualConditions,
                    ...(sheetSummary?.activeConditions ?? []),
                  ]),
                ].map((condition) => (
            ...
            <div className="tadeon-entity-dossier__actions">
              ...
              {(sheetSummary?.sheetId || entity.linkedSheetId) && (
                <Button variant="outline" asChild>
                  <a
                    href={`/sheet/${sheetSummary?.sheetId ?? entity.linkedSheetId}`}
                  >
                    <ExternalLink aria-hidden="true" /> Abrir ficha completa
                  </a>
                </Button>
              )}
              {entity.linkedKnowledgeNodeId && (
                <Button variant="outline" asChild>
                  <a
                    href={`/nexus?node=${encodeURIComponent(entity.linkedKnowledgeNodeId)}`}
                  >
