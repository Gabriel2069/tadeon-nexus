...
import contextTransitionMotionCss from "../styles/tadeon-context-transition-motion.css?url";
import portalSurfaceMotionCss from "../styles/tadeon-portal-surface-motion.css?url";
import popupRefinementMotionCss from "../styles/tadeon-popup-refinement-motion.css?url";
...
import ultimateMotionPolishCss from "../styles/tadeon-motion-polish-ultimate.css?url";
import motionLoomCss from "../styles/tadeon-motion-loom.css?url";
import finalDefectAuthorityCss from "../styles/tadeon-final-defect-authority.css?url";
