...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: headRepairCss }, { rel: "stylesheet", href: stateFeedbackCss }, { rel: "stylesheet", href: shellBackgroundRepairCss }, { rel: "stylesheet", href: headParityNextCss }, { rel: "stylesheet", href: navigationAmbientCss }, { rel: "stylesheet", href: tabletopThreeLineCss }, { rel: "stylesheet", href: headNexusReferenceCss }, { rel: "stylesheet", href: headCompositionFixCss },
