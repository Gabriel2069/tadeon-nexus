  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <Card className="w-full max-w-md p-8 bg-card/80 backdrop-blur border-border">
        <h1 className="font-cinzel text-2xl font-bold text-primary text-center mb-2">Redefinir Senha</h1>
        ...
        {ready ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input id="confirm" type="password" minLength={6} required value={confirm}
